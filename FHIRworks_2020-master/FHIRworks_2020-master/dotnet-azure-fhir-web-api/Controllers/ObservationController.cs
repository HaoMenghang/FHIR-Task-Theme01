...
namespace HDR_UK_Web_Application.Controllers
{
    ...
    public class ObservationController : ControllerBase
    {
        ...
        public async Task<List<JObject>> GetObservations([FromQuery]string id)
        {
        ...
        [HttpGet("GetSingleObservation")]
        public async Task<JObject> GetSingleObservation([FromQuery]string id)
        {
